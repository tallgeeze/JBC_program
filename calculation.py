...
def plot_at(file_num, dim,ch):
    ...
    if ch == 'worst':
        ...
        print(model)
        print("worst model coefficience \n")
...
xx=range(0,180)
j=0
coeff_3 = [ -2.15040648e-07,  7.45121152e-05,  -8.31098451e-03,2.55176793e-01,
   1.71617703e+01]
#for i in xx:
    #yy[j]=est_v3 = coeff_3 [0]*(xx^4)+coeff_3 [1]*(xx^3)+coeff_3 [2]*(xx^2)+coeff_3 [3]*(xx^1)+coeff_3 [4];
yy = pylab.polyval(coeff_3, xx)
pylab.plot(xx,yy)
pylab.show()
